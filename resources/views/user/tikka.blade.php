...
<head>
    ...
    <link rel="preload" href="../models/tikka 3d model2.glb" as="fetch" crossorigin="anonymous">
    ...
    <div class="food-container">
        ...
        <div class="viewer-section">
            ...
            <h1>Tikka</h1>
                       ...
                       <model-viewer
id="burgerModel"
src="{{ asset('website//models/tikka 3d model2.glb')}}"
...
☰
        ...
        <p>
           Tender chicken tikka marinated in traditional spices and grilled to perfection, delivering a smoky aroma and rich flavor in every bite.
        </p>
    ...
    <div id="fake-ar" class="fake-ar hidden">
        ...
        <model-viewer src="{{ asset('website/models/tikka 3d model2.glb')}}" camera-controls auto-rotate style="width:100%;height:100%;"
    ...
    <div id="sidebar">
        ...
        <div class="recommendations">
            ...
            <div class="rec-grid">
                ...
                <a href="{{ route('boti_roll.3d') }}" class="rec-card">
                    <img style="height: 190px; width: 190px;" src="c" alt="{{ asset('website/images/boti roll image.jpg')}}">
                    <!-- <model-viewer src="../models/fried_chicken 3D model.glb" auto-rotate camera-controls>
                    </model-viewer> -->
                    <p>Boti Roll</p>
                </a>
